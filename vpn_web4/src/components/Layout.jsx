...
import { HomeOutlined, GlobalOutlined, CreditCardOutlined, HistoryOutlined, CustomerServiceOutlined, UserOutlined, LogoutOutlined, KeyOutlined, QqOutlined, WechatOutlined, PhoneOutlined } from '@ant-design/icons';
import { useState, useEffect } from 'react';
import request from '../utils/request';
import { Tag } from 'antd';
import { useAtomValue, useSetAtom } from 'jotai';
import { balanceAtom, isLoginAtom, updateLoginAtom, updateBalanceAtom } from '../jotai';
...
const LayoutComponent = () => {
  ...
  const updateLogin = useSetAtom(updateLoginAtom);
          ...
          <div className="w-full px-4">
            <div className="flex items-center justify-between h-16 max-w-7xl mx-auto">
              <div className="flex items-center space-x-8">
                <div className="text-2xl font-bold text-blue-600">EasyVPN</div>
                <Menu
                  mode="horizontal"
