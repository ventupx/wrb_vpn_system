...
const OrderHistory = () => {
  ...
  const [hoveredOrderKey, setHoveredOrderKey] = useState(null);
            ...
            {filteredOrders.map(order => (
              <Col xs={24} sm={12} md={8} key={order.key}>
                <Card 
                  ...
                  bordered
                  onMouseEnter={() => setHoveredOrderKey(order.key)}
                  onMouseLeave={() => setHoveredOrderKey(null)}
                >
                  {hoveredOrderKey === order.key && (
