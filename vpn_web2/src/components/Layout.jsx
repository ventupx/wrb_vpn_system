...
import { Layout, Menu, Dropdown, Space, Button, Tooltip, Popover, message } from 'antd';
import { HomeOutlined, GlobalOutlined, CreditCardOutlined, HistoryOutlined, UserOutlined, LogoutOutlined, KeyOutlined, QqOutlined, WechatOutlined, PhoneOutlined } from '@ant-design/icons';
      ...
      {!shouldHideHeader && (
        ...
        <div className="w-full px-4">
          <div className="flex items-center justify-between h-16 max-w-7xl mx-auto">
            <div className="text-2xl font-bold text-blue-600">SimpleVPN</div>
            <Menu
              mode="horizontal"
